...
- (void)setModel:(GKWYMusicModel *)model {
    ...
    self.artistLabel.text = [NSString stringWithFormat:@"%@ - %@", model.artists_name, model.al.name];
...
- (void)setSongModel:(GKWYMusicModel *)songModel {
    ...
    self.artistLabel.text = [NSString stringWithFormat:@"%@ - %@", songModel.artists_name, songModel.al.name];
