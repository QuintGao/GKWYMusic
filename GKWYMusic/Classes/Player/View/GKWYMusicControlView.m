...
- (void)setIs_download:(BOOL)is_download {
    _is_download = is_download;
    
    if (is_download) {
        [self setupDownloadedBtn];
    }else {
...
- (void)setupDownloadBtn {
    [self.downloadBtn setImage:[UIImage imageNamed:@"cm2_icn_dld"] forState:UIControlStateNormal];
    [self.downloadBtn setImage:[UIImage imageNamed:@"cm2_icn_dld_prs"] forState:UIControlStateHighlighted];
}

- (void)setupDownloadedBtn {
    [self.downloadBtn setImage:[UIImage imageNamed:@"cm2_icn_dlded"] forState:UIControlStateNormal];
    [self.downloadBtn setImage:[UIImage imageNamed:@"cm2_icn_dlded_prs"] forState:UIControlStateHighlighted];
}
